...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','be.k0suke.tijvfloatlabeledtextfield.js')
...
""" % module_assets
	...
	assets_router = os.path.join(cwd,'Classes','BeK0sukeTijvfloatlabeledtextfieldModuleAssets.m')
